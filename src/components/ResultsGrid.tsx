                ...
                <table className="w-full text-left border-collapse min-w-max">
                    <thead>
                        <tr className="border-b border-slate-700 text-sm text-slate-400">
                            ...
                            <th className="p-3 static md:sticky md:left-[140px] z-20 bg-slate-900 min-w-[120px] border-r border-slate-700/50">Boat Name</th>
                            <th className="p-3 static md:sticky md:left-[260px] z-20 bg-slate-900 min-w-[80px] text-center border-r border-slate-800">Sail #</th>
                    ...
                    <tbody>
                        {boats.map(boat => (
                            <tr key={boat.id} className="border-b border-slate-700/50 hover:bg-slate-800/30 transition group">
                                ...
                                <td className="p-3 static md:sticky md:left-[140px] z-10 bg-slate-900/95 group-hover:bg-slate-800 transition-colors text-slate-400 text-sm border-r border-slate-700/50">
                                    {boat.boatName || '-'}
                                </td>
                                <td className="p-3 static md:sticky md:left-[260px] z-10 bg-slate-900/95 group-hover:bg-slate-800 transition-colors text-slate-400 font-mono text-center border-r border-slate-800">
                                    {boat.sailNumber}
                                </td>
